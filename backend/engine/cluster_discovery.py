    ...
    def cluster_archive(self, tiles_data: List[Dict[str, Any]], embeddings: np.ndarray) -> Dict[str, Any]:
        ...
        for i, tile in enumerate(tiles_data):
            ...
            point_obj = {
                ...
                "bbox_min_lat": tile.get("bbox_min_lat"),
                "bbox_min_lon": tile.get("bbox_min_lon"),
                "bbox_max_lat": tile.get("bbox_max_lat"),
                "bbox_max_lon": tile.get("bbox_max_lon"),
                "bbox": [
                    tile.get("bbox_min_lat", tile.get("center_lat", 28.6139) - 0.005),
                    tile.get("bbox_min_lon", tile.get("center_lon", 77.2090) - 0.005),
                    tile.get("bbox_max_lat", tile.get("center_lat", 28.6139) + 0.005),
                    tile.get("bbox_max_lon", tile.get("center_lon", 77.2090) + 0.005)
                ],
                "acquisition_date": tile.get("acquisition_date", "2025-02-10"),
                "sensor_name": tile.get("sensor_name", "Sentinel-2 MSI"),
                "preview_path": tile.get("rgb_preview_path"),
                "rgb_preview_path": tile.get("rgb_preview_path"),
